...
return (
  <div>
    ...
    <form onSubmit={handleSubmit}>
      ...
      <br />
      Title 
      <input type="text" name="title" placeholder="Enter title" required class="w-full text-input pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"/> <br />
      <br />  
      Description 
      <input type="text" name="description" placeholder="Enter description" required class="w-full text-input pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"/><br />
      <br />
      Category 
